...
- (void)setPermissionAskingAt:(enum JivoSDKNotificationsPermissionAskingMoment)moment notificationHandler:(enum JivoSDKNotificationsPermissionAskingHandler)notificationHandler;
...
@protocol JivoSDKNotificationsDelegate
@optional
- (void)jivoNeedAccessToNotifications:(SWIFT_METATYPE(JivoSDK) _Nonnull)sdk proceedHandler:(void (^ _Nonnull)(void))proceedHandler;
@end
