Pod::Spec.new do |root|
    ...
    root.subspec 'SDK' do |spec|
        spec.dependency 'JFMarkdownKit', '2.0.0'
        spec.dependency 'JFEmojiPicker', '2.0.0'
        spec.dependency 'JFWebSocket', '3.0.0'
        spec.dependency 'JMCodingKit', '6.0.0'
        spec.dependency 'JMRepicKit', '2.0.0'
        spec.dependency 'JMTimelineKit', '6.0.0'
        spec.dependency 'JMMarkdownKit', '2.0.0'
        spec.dependency 'JMDesignKit', '2.0.0'
        spec.dependency 'JMOnetimeCalculator', '2.0.0'
        spec.dependency 'JMScalableView', '2.0.0'
        spec.dependency 'JMSidePanelKit', '2.0.0'
        spec.dependency 'TypedTextAttributes', '~> 1.4.0'
        spec.dependency 'PureParser', '~> 2.0.0'
