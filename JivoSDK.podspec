Pod::Spec.new do |root|
    ...
    root.authors = { "Anton Karpushko" => "karpushko@jivosite.com", "Stan Potemkin" => 
"potemkin@jivosite.com" }
...
"v#{root.version}" }
    ...
    root.subspec 'SDK' do |spec|
        ...
        spec.resource = 'JivoSDK/Resources/Assets.xcassets', 'JivoSDK/Resources/*.lproj', 
'JivoSDK/*.docc'
