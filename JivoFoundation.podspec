Pod::Spec.new do |root|
    ...
    root.source = { :git => 'https://github.com/JivoChat/JivoSDK-iOS.git', :tag => 
"v#{root.version}" }
    ...
    root.subspec 'Tools' do |spec|
        ...
        spec.source_files = 'Shared/Sources/Tools/BroadcastTool', 
'Shared/Sources/Tools/PureParserTool'
    ...
    root.subspec 'Database' do |spec|
        ...
        spec.dependency 'JivoFoundation/Tools'
        spec.source_files = 'Shared/Models', 'Shared/Models/**/*.swift', 
'Shared/Sources/Drivers/DatabaseDriver/**/*.swift', 'Shared/Sources/Threading', 'Shared/Sources/Extensions/System/*+{database,locale}.swift'
