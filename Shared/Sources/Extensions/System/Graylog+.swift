...
extension Graylog {
    ...
    static func jv_buildPayload(brief: String, details: String?, file: String, line: Int, includeCaches: Bool) -> GraylogPayload {
        let values: [JsonElement?] = [
            ...
            JsonElement(key: "_app_version", value: Bundle.main.jv_formatVersion(.marketingShort)),
            JsonElement(key: "_app_full_version", value: Bundle.main.jv_formatVersion(.semanticFull)),
