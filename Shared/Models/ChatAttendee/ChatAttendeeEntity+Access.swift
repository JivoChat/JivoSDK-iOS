//
//  ChatAttendeeEntity+Access.swift
//  App
//
...
enum JVChatAttendeeRelation: Equatable {
    ...
    case invitedByAgent(AgentEntity, toAssist: Bool, comment: String?)
    case attendee(agent: AgentEntity?, toAssist: Bool, comment: String?)
    case team
