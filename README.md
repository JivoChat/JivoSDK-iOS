...
Описание методов и свойств, составляющих нативный Jivo SDK API, содержится в [этом документе]().

### Для React Native

Описание методов, составляющих Jivo SDK JavaScript API, вы можете найти в [разделе “Описание методов” здесь](). Остальные разделы этого документа при отсутствии ссылки на адаптированную версию актуальны и для React Native проектов.
